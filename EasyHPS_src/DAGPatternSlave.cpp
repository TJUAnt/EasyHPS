 ...
 */
void Slave_init_dag_pattern(PosT dag_pos, SizeT dag_size, SizeT block_size, Process_t process, enum DAG_pattern_type dag_pattern_type)
{
    int i,j,k,cnt,p;
    Init_DAG_lock();
    ...
    dag_pattern.dag_pattern_finish = NULL;
    ...
    SetDAGPattern(dag_pattern.dag_pattern_element,dag_pattern.dag_size,dag_pattern.block_size,dag_pattern.rect_size,dag_pattern.dag_pos, dag_pattern_type,NULL);  
    return;
}
